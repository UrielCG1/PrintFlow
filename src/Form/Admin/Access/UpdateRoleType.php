...
final class UpdateRoleType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('permissions', EntityType::class, [
                ...
                'multiple' => true,
                'expanded' => true,
                'disabled' => !$options['allow_permission_edit'],
                'constraints' => [
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => UpdateRoleData::class,
            'allow_permission_edit' => true,
        ]);

        $resolver->setAllowedTypes('allow_permission_edit', 'bool');
    }
}