...
{
 /** Variante y clave primaria de la proyección. */ #[ORM\Id,ORM\OneToOne] #[ORM\JoinColumn(name:'material_variant_id',onDelete:'RESTRICT')] private MaterialVariant $variant;
