...
class SupplierAddress { use Timestampable;
    ...
    public function getId():?int{return $this->id;} public function getSupplier():Supplier{return $this->supplier;} public function getBranch():?SupplierBranch{return $this->branch;} public function setBranch(?SupplierBranch $v):self{$this->branch=$v;return $this;} public function getAddress():Address{return $this->address;} public function getAddressType():string{return $this->addressType;} public function getDeliveryZone():?DeliveryZone{return $this->deliveryZone;} public function getDeliveryCost():?string{return $this->deliveryCost;} public function isDefault():bool{return $this->isDefault;} public function isActive():bool{return $this->isActive;}
