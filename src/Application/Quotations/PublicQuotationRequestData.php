...
final class PublicQuotationRequestData
{
 ...
 #[Assert\NotBlank,Assert\Length(max:150)] public ?string $fullName=null;
 #[Assert\NotBlank,Assert\Email,Assert\Length(max:180)] public ?string $email=null;
 #[Assert\NotBlank,Assert\Length(max:30)] public ?string $phone=null;
